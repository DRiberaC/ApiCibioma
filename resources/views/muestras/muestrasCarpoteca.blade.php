...
@section('contend')
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('coleccion.create', [$tipo->slug]) }}"><button type="button"
                            class="btn btn-primary">Registrar nueva colección</button></a>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="myform" action="{{ route('coleccion.importar.carpoteca') }}" method="POST"
                            ...
                            @foreach ($muestras as $muestra)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p class="mt-1">
                                            <a href="{{ route('coleccion.edit', [$muestra]) }}"><button type="button"
                                                    class="btn btn-xs btn-warning">Editar</button></a>
                                        </p>
                                        <p class="mt-1">
                                            <a href="{{ route('coleccion.imagen', [$muestra]) }}"><button type="button"
                                                    class="btn btn-xs btn-primary">Ver Imagenes</button></a>
                                        </p>
                                        <p class="mt-1">
